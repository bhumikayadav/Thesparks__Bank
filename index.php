...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color :#DC143C;">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                <h2 style = "color :black; margin-bottom:40px; ">BASIC BANKING SYSTEM </h2>
                  <h3><strong> Welcome to</h3></strong>
                  <h1 style = "color :#883E2F; ">SPARK BANK</h1>
      ...
      <!-- Activity section -->
            <div class="row activity text-center" style="background-color : #FFF8DC;">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Bhumika Yadav</b> <br> The Spark Foundation</p>
      </footer>
